...
public class DiscoveryEnabledNIWSServerList extends AbstractServerList<DiscoveryEnabledServer> {
    ...
    /**
     * @param vipAddresses
     * @deprecated use {@link #DiscoveryEnabledNIWSServerList(String, Provider)}
     */
    @Deprecated
    ...
    /**
     * @param clientConfig
     * @deprecated use {@link #DiscoveryEnabledNIWSServerList(IClientConfig, Provider)}
     */
    @Deprecated
    ...
    public void initWithNiwsConfig(IClientConfig clientConfig) {
        ...
        if (this.registryService == null) {
            ...
            this.registryService = (RegistryService) context.getBean("registryService");
        }
    }
    ...
    private List<DiscoveryEnabledServer> obtainServersViaDiscovery() {
        ...
        if (vipAddresses != null) {
            for (String vipAddress : vipAddresses.split(",")) {
                Application application = registryService.getApplications(vipAddress);
