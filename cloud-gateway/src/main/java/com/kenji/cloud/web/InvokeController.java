...
//    private BaseLoadBalancer baseLoadBalancer;
    ...
    public String invoke(@RequestParam Map<String, String> requestParams) throws IllegalAccessException, InstantiationException {
        ...
        ZoneAwareLoadBalancer zoneAwareLoadBalancer = (ZoneAwareLoadBalancer) ribbonLoadBalancerClient.getLoadBalancer(serviceNames[0]);
     ...
     //   ServiceInstance instance = loadBalancer.choose(serviceNames[0]);
